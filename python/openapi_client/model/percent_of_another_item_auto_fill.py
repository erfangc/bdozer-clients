...
class PercentOfAnotherItemAutoFill(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, label, percent_of_another_item, *args, **kwargs):  # noqa: E501
        """PercentOfAnotherItemAutoFill - a model defined in OpenAPI
        ...
        self.label = label
        self.percent_of_another_item = percent_of_another_item
