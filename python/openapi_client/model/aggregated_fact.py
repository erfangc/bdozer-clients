...
class AggregatedFact(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, fact_ids, value, concept_name, document_period_end_date, *args, **kwargs):  # noqa: E501
        """AggregatedFact - a model defined in OpenAPI
