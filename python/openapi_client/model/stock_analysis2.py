...
class StockAnalysis2(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, get_id, model, cells, tags, published, last_updated, *args, **kwargs):  # noqa: E501
        """StockAnalysis2 - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            derived_stock_analytics (DerivedStockAnalytics): [optional]  # noqa: E501
