...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = CommentsControllerApi()
        api_instance.get_comments  # this is an instance of the class Endpoint
        api_instance.get_comments()  # this invokes api_instance.get_comments.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.get_comments.callable or self.callable in this class
